...
next_step: Upload the 1-3 minute demo video, set `LIARLINE_DEMO_VIDEO_URL`, and run strict judge readiness with the public URLs.
blockers: ["External demo video URL is still required for a true strict 100 ceiling."]
