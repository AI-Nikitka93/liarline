...
<style>
  html,body{margin:0;width:390px;height:844px;background:#080a0d;color:#f4f6f8;font-family:Inter,Arial,sans-serif}
  ...
  .card{width:330px;border:1px solid #31404a;border-radius:8px;background:rgba(14,18,24,.92);padding:24px;box-shadow:0 18px 42px rgba(0,0,0,.45)}
  .kicker{margin:0 0 18px;color:#5eead4;font:700 12px ui-monospace,Menlo,monospace;text-transform:uppercase;letter-spacing:.08em}
  h1{font-size:34px;line-height:38px;margin:0;font-weight:850;letter-spacing:0}
  .subtitle{margin:18px 0 0;color:#cbd5e1;font-size:17px;line-height:25px}
  .proof{margin-top:22px;border-top:1px solid #31404a;padding-top:14px;color:#fb7185;font:700 11px ui-monospace,Menlo,monospace;text-transform:uppercase}
...
function writeManifest(file, lang, pkg, result) {
  const manifest = {
    ...
    capabilityMatrix: [
      ...
      { capability: "TTS / M:\\AI\\Speak", status: "AVAILABLE_NOT_USED", usedFor: "voiceover skipped", note: "silent captioned delivery chosen to avoid late bilingual voice risk" },
    ...
    notes: [
      ...
      "MP4/WebM contain no audio. SRT is included for platform captions.",
